...
public class DisablePlayerVisibility : MonoBehaviour
{
    ...
    public BranchingDialogue branchingDialogue;
    ...
    private void CheckForPlayer()
    {
        ...
        else if(!playerCurrentlyInZone && playerInZone && branchingDialogue.isCoroutineRunning == true)
        {
            SwitchPlayerLayer(playerGO, 10);
        }
